                    ...
                    <Row>
                        <Col md={4} sm={4} xs={12}>
                            <ul className="social-icon d-flex">
                                <li><Link to="http://facebook.com">{fbIcon}</Link></li>
                                <li><Link to="http://twitter.com">{twitIcon}</Link></li>
                                <li><Link to="http://pintarest.com">{pintrstIcon}</Link></li>
                                <li><Link to="http://instagram.com">{instaIcon}</Link></li>
                            </ul>
                        </Col>
                    ...
                    <Row>
                        <Navbar variant="light" collapseOnSelect expand="md">
                            ...
                            <Navbar.Collapse className='justify-content-end nav-menu'>
                                ...
                                {user?.displayName ?
                                    <Nav.Link activeStyle={activeLink} as={NavLink} to="/my-orders">My Orders</Nav.Link> : ""}                                
                                {user?.displayName ?
                                    <Nav.Link activeStyle={activeLink} as={NavLink} to="/manage-order">Manage Order</Nav.Link> : ""}
                                {user?.displayName ?
                                    <Nav.Link activeStyle={activeLink} as={NavLink} to="/addservice">Add Services</Nav.Link> : ""}  
                            </Navbar.Collapse>
                        </Navbar>
                    </Row>
                </Container>
